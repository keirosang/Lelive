...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    <header class="mdl-layout__header header-background-image">
        <div class="mdl-layout__header-row">
            ...
            <nav class="mdl-navigation mdl-layout--large-screen-only">
                ...
                @else
                    <a class="mdl-navigation__link" href="{{ url('/admin') }}">{{ Auth::guard('admin')->user()->name }}</a>
                    <a class="mdl-navigation__link" href="{{ url('/admin/logout') }}">Logout</a>
                @endif
            </nav>
        </div>
    </header>
    <div class="mdl-layout__drawer">
        ...
        <nav class="mdl-navigation">
            ...
            @else
                <a class="mdl-navigation__link" href="{{ url('/admin') }}">{{ Auth::guard('admin')->user()->name }}</a>
                <a class="mdl-navigation__link" href="{{ url('/admin/logout') }}">登出</a>
            @endif
        </nav>
    </div>
